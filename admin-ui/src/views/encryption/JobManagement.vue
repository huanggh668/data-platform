      ...
      <el-col :span="14">
        <el-card>
          ...
          <el-table :data="items" stripe>
            ...
            <el-table-column prop="algorithmId" label="算法" width="130">
            ...
            <el-table-column prop="operation" label="操作" width="100">
              <template #default="{ row }">
                <el-tag>{{ row.operation === 'ENCRYPT' ? '加密' : '解密' }}</el-tag>
              </template>
            </el-table-column>
        ...
        <el-card>
          ...
          <el-form :model="form" label-width="100px">
            ...
            <el-form-item label="加密算法">
              <el-select v-model="form.algorithmId" placeholder="选择算法">
                <el-option
...
async function loadAlgorithms() {
  try {
    ...
    algorithms.value = response.data || response || []
  } catch (error) {
    ElMessage.error(error.message)
  }
}
...
function editItem(row) {
  ...
  Object.assign(form, {
    ...
    operation: row.operation || 'ENCRYPT',
...
onMounted(() => { loadItems(); loadAlgorithms() })
